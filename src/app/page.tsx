    ...
    <>
      <header>
        <nav>
          ...
          <p style={{ textAlign: 'center', fontSize: '1rem', lineHeight: '1.6', maxWidth: '700px', margin: '0 auto', padding: '0 2rem 2rem', opacity: 0.75 }}>Click the left and right sides to see information regarding the film&rsquo;s development of lower class and upper class identities, respectively. Scroll down for more info. The choices made in Parasite culminate in a successful argument explaining how class divisions lead to differing identities and conflicts.</p>
        </nav>
      </header>
